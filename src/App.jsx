...
function HomePage({ theme, formData, setFormData, generateKundli, loading, loadingMsg, apiError, darkMode, setDarkMode, lang, setLang, savedKundlis }) {
  ...
  const CITIES = [
    ...
    {name:"Chitwan, Nepal",         lat:27.5291,  lon:84.3542},
    {name:"Kirtipur, Nepal",        lat:27.6781,  lon:85.2775},
    {name:"Banepa, Nepal",          lat:27.6325,  lon:85.5214},
    {name:"Dhulikhel, Nepal",       lat:27.6221,  lon:85.5428},
    {name:"Tansen, Nepal",          lat:27.8686,  lon:83.5460},
    {name:"Baglung, Nepal",         lat:28.2719,  lon:83.5898},
    {name:"Besisahar, Nepal",       lat:28.2342,  lon:84.3772},
    {name:"Lamjung, Nepal",         lat:28.2765,  lon:84.3542},
    {name:"Sindhuli, Nepal",        lat:27.2567,  lon:85.9719},
    {name:"Charikot, Nepal",        lat:27.6710,  lon:86.0333},
    {name:"Jiri, Nepal",            lat:27.6342,  lon:86.2306},
    {name:"Okhaldhunga, Nepal",     lat:27.3167,  lon:86.5000},
    {name:"Phidim, Nepal",          lat:27.1475,  lon:87.7653},
    {name:"Taplejung, Nepal",       lat:27.3547,  lon:87.6950},
    {name:"Ilam, Nepal",            lat:26.9094,  lon:87.9282},
    {name:"Bhadrapur, Nepal",       lat:26.5443,  lon:88.0944},
    {name:"Rajbiraj, Nepal",        lat:26.5333,  lon:86.7500},
    {name:"Lahan, Nepal",           lat:26.7200,  lon:86.4800},
    {name:"Siraha, Nepal",          lat:26.6550,  lon:86.2070},
    {name:"Malangwa, Nepal",        lat:26.8570,  lon:85.5590},
    {name:"Gaur, Nepal",            lat:26.7640,  lon:85.2774},
    {name:"Kalaiya, Nepal",         lat:27.0236,  lon:85.0000},
    {name:"Parasi, Nepal",          lat:27.5167,  lon:83.7667},
    {name:"Taulihawa, Nepal",       lat:27.5410,  lon:83.0500},
    {name:"Sandhikharka, Nepal",    lat:27.9717,  lon:83.7600},
    {name:"Pyuthan, Nepal",         lat:28.1000,  lon:82.8667},
    {name:"Rolpa, Nepal",           lat:28.3000,  lon:82.6000},
    {name:"Jumla, Nepal",           lat:29.2750,  lon:82.1833},
    {name:"Dolpa, Nepal",           lat:28.9850,  lon:82.8200},
    {name:"Simikot, Nepal",         lat:29.9750,  lon:81.8200},
    {name:"Mahendranagar, Nepal",   lat:28.9639,  lon:80.1771},
    {name:"Dadeldhura, Nepal",      lat:29.2970,  lon:80.5800},
    {name:"Baitadi, Nepal",         lat:29.5333,  lon:80.5500},
    {name:"Darchula, Nepal",        lat:29.8500,  lon:80.5500},
    // India
